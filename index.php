...
<body>
    <div class="ms_container">
        <header class="container-fluid py-3  ms_header">
            <div class="row header-top">
                <div class="col mb-3">
                    <h3 class="ms_contenitore_lettere_google text-primary d-inline block ms_margine_negativo me-3">
                        <span>G</span>
                    ...
                    <h3 class="text-secondary fw-light d-inline block">Privacy e Termini</h3>
                </div>

            </div>
            <div class="row header-bottom">
              <div class="col pt-2">
                 <span class="text-secondary me-3">Introduzione</span>
                 <span class="text-secondary me-3">Norme sulla Privacy</span>
                 <span class="text-secondary me-3">Termini di Servizio</span>
                 <span class="text-secondary me-3">Tecologie</span>
                 <span class="ms_active text-primary me-3 ">Domande frequenti</span>
              </div>
            </div>
        </header>

        <!-- aggiungere un explode per andare a capo ogni punto? -->

        <main>
            <div class="container py-5 ms_contenitore_faq">
                <?php
                foreach($faq as $section => $content){
                    
                    echo "<div class='faq'>";
                        // ciclo internamente le sezioni 
                        foreach($content as $type => $text){
                            if($type == "domanda"){
                                echo "<h2> $text </h2>";
                            } elseif ($type =="risposta"){
                                echo "<p> $text </p>";
                            } 
                        }
                    echo "</div>";
